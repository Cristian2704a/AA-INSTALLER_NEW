...
```bash
sudo apt install -y git && git clone https://github.com/Cristian2704a/AA-INSTALLER_NEW autoatende && sudo chmod -R 777 ./autoatende && cd ./autoatende && sudo ./install_primaria
```
