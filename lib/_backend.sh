...
GROUPS_PROCESSING_ENABLED=true
GROUPS_QUEUE_CONCURRENCY=2
GROUPS_QUEUE_MAX_RETRY=3
GROUPS_BATCH_SIZE=100

REDIS_CONNECT_TIMEOUT=60000
REDIS_COMMAND_TIMEOUT=30000

WORKER_CONCURRENCY_GENERAL=1
WORKER_CONCURRENCY_MESSAGE=3
WORKER_CONCURRENCY_CAMPAIGN=2

GENERAL_JOBS_PER_MINUTE=10
MESSAGE_JOBS_PER_MINUTE=50
CAMPAIGN_JOBS_PER_MINUTE=15

CACHE_MAX_SIZE=1000
CACHE_TTL_SECONDS=300
COMPANIES_CACHE_TTL=600

UV_THREADPOOL_SIZE=16
ENABLE_GC_MONITORING=false
AUTO_IMPORT_CONTACTS_DURING_SYNC=false
SYNC_GROUP_CONTACTS_DELAY=500
MAX_CONTACTS_PER_BATCH=50
ENABLE_CONTACT_IMPORT_LOGGING=false
